...
namespace Microsoft.ExcelServices
{
	...
	public class TableRowCollection: OfficeExtension.ClientObject
	{
		private int m_count;
		private Microsoft.ExcelServices.TableRow[] m__items;

		/* Begin_PlaceHolder_TableRowCollection_Custom_Members */
		/* End_PlaceHolder_TableRowCollection_Custom_Members */
		public TableRowCollection(OfficeExtension.ClientRequestContext context, OfficeExtension.ObjectPath objectPath)
		...
		public Microsoft.ExcelServices.TableRow[] Items
		{
			get
			{
		...
		public Microsoft.ExcelServices.TableRow Add(int index, object values)
		{
			/* Begin_PlaceHolder_TableRowCollection_Add */
			/* End_PlaceHolder_TableRowCollection_Add */
			return new Microsoft.ExcelServices.TableRow(this.Context, OfficeExtension.ObjectPathFactory._CreateMethodObjectPath(this.Context, this, "Add", OfficeExtension.OperationType.Default, new object[] {index, values}, false /*isCollection*/, true /*isInvalidAfterRequest*/));
		}

		public Microsoft.ExcelServices.TableRow GetItemAt(int index)
		{
			/* Begin_PlaceHolder_TableRowCollection_GetItemAt */
			/* End_PlaceHolder_TableRowCollection_GetItemAt */
			return new Microsoft.ExcelServices.TableRow(this.Context, OfficeExtension.ObjectPathFactory._CreateMethodObjectPath(this.Context, this, "GetItemAt", OfficeExtension.OperationType.Read, new object[] {index}, false /*isCollection*/, false /*isInvalidAfterRequest*/));
		}
		...
		public override void _HandleResult(Newtonsoft.Json.Linq.JToken value)
		{
			...
			if (itemsData != null)
			{
				this.m__items = new Microsoft.ExcelServices.TableRow[itemsData.Count];
				for (var i = 0; i < itemsData.Count; i++)
				{
					var _item = new Microsoft.ExcelServices.TableRow(this.Context, OfficeExtension.ObjectPathFactory._CreateChildItemObjectPathUsingIndexerOrGetItemAt(false, this.Context, this, itemsData[i], i));
		 ...
		 */
		public Microsoft.ExcelServices.TableRowCollection Load(OfficeExtension.LoadOption option) 
		{
