...
namespace Microsoft.ExcelServices
{
	...
	public class BindingCollection: OfficeExtension.ClientObject
	{
		private int m_count;
		private Microsoft.ExcelServices.Binding[] m__items;

		/* Begin_PlaceHolder_BindingCollection_Custom_Members */
		/* End_PlaceHolder_BindingCollection_Custom_Members */
		public BindingCollection(OfficeExtension.ClientRequestContext context, OfficeExtension.ObjectPath objectPath)
		...
		public Microsoft.ExcelServices.Binding[] Items
		{
			get
			{
		...
		public Microsoft.ExcelServices.Binding GetItem(string id)
		{
			/* Begin_PlaceHolder_BindingCollection_GetItem */
			/* End_PlaceHolder_BindingCollection_GetItem */
			return new Microsoft.ExcelServices.Binding(this.Context, OfficeExtension.ObjectPathFactory._CreateIndexerObjectPath(this.Context, this, new object[] {id}));
		}

		public Microsoft.ExcelServices.Binding GetItemAt(int index)
		{
			/* Begin_PlaceHolder_BindingCollection_GetItemAt */
			/* End_PlaceHolder_BindingCollection_GetItemAt */
			return new Microsoft.ExcelServices.Binding(this.Context, OfficeExtension.ObjectPathFactory._CreateMethodObjectPath(this.Context, this, "GetItemAt", OfficeExtension.OperationType.Read, new object[] {index}, false /*isCollection*/, false /*isInvalidAfterRequest*/));
		}
		...
		public override void _HandleResult(Newtonsoft.Json.Linq.JToken value)
		{
			...
			if (itemsData != null)
			{
				this.m__items = new Microsoft.ExcelServices.Binding[itemsData.Count];
				for (var i = 0; i < itemsData.Count; i++)
				{
					var _item = new Microsoft.ExcelServices.Binding(this.Context, OfficeExtension.ObjectPathFactory._CreateChildItemObjectPathUsingIndexerOrGetItemAt(true, this.Context, this, itemsData[i], i));
