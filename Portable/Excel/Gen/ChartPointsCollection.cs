...
namespace Microsoft.ExcelServices
{
	...
	public class ChartPointsCollection: OfficeExtension.ClientObject
	{
		private int m_count;
		private Microsoft.ExcelServices.ChartPoint[] m__items;

		/* Begin_PlaceHolder_ChartPointsCollection_Custom_Members */
		/* End_PlaceHolder_ChartPointsCollection_Custom_Members */
		public ChartPointsCollection(OfficeExtension.ClientRequestContext context, OfficeExtension.ObjectPath objectPath)
		...
		public Microsoft.ExcelServices.ChartPoint[] Items
		{
			get
			{
		...
		public Microsoft.ExcelServices.ChartPoint GetItemAt(int index)
		{
			/* Begin_PlaceHolder_ChartPointsCollection_GetItemAt */
			/* End_PlaceHolder_ChartPointsCollection_GetItemAt */
			return new Microsoft.ExcelServices.ChartPoint(this.Context, OfficeExtension.ObjectPathFactory._CreateMethodObjectPath(this.Context, this, "GetItemAt", OfficeExtension.OperationType.Read, new object[] {index}, false /*isCollection*/, false /*isInvalidAfterRequest*/));
		}
		...
		public override void _HandleResult(Newtonsoft.Json.Linq.JToken value)
		{
			...
			if (itemsData != null)
			{
				this.m__items = new Microsoft.ExcelServices.ChartPoint[itemsData.Count];
				for (var i = 0; i < itemsData.Count; i++)
				{
					var _item = new Microsoft.ExcelServices.ChartPoint(this.Context, OfficeExtension.ObjectPathFactory._CreateChildItemObjectPathUsingIndexerOrGetItemAt(false, this.Context, this, itemsData[i], i));
		 ...
		 */
		public Microsoft.ExcelServices.ChartPointsCollection Load(OfficeExtension.LoadOption option) 
		{
