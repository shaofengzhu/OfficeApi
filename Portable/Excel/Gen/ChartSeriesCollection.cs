...
namespace Microsoft.ExcelServices
{
	...
	public class ChartSeriesCollection: OfficeExtension.ClientObject
	{
		private int m_count;
		private Microsoft.ExcelServices.ChartSeries[] m__items;

		/* Begin_PlaceHolder_ChartSeriesCollection_Custom_Members */
		/* End_PlaceHolder_ChartSeriesCollection_Custom_Members */
		public ChartSeriesCollection(OfficeExtension.ClientRequestContext context, OfficeExtension.ObjectPath objectPath)
		...
		public Microsoft.ExcelServices.ChartSeries[] Items
		{
			get
			{
		...
		public Microsoft.ExcelServices.ChartSeries GetItemAt(int index)
		{
			/* Begin_PlaceHolder_ChartSeriesCollection_GetItemAt */
			/* End_PlaceHolder_ChartSeriesCollection_GetItemAt */
			return new Microsoft.ExcelServices.ChartSeries(this.Context, OfficeExtension.ObjectPathFactory._CreateMethodObjectPath(this.Context, this, "GetItemAt", OfficeExtension.OperationType.Read, new object[] {index}, false /*isCollection*/, false /*isInvalidAfterRequest*/));
		}
		...
		public override void _HandleResult(Newtonsoft.Json.Linq.JToken value)
		{
			...
			if (itemsData != null)
			{
				this.m__items = new Microsoft.ExcelServices.ChartSeries[itemsData.Count];
				for (var i = 0; i < itemsData.Count; i++)
				{
					var _item = new Microsoft.ExcelServices.ChartSeries(this.Context, OfficeExtension.ObjectPathFactory._CreateChildItemObjectPathUsingIndexerOrGetItemAt(false, this.Context, this, itemsData[i], i));
		 ...
		 */
		public Microsoft.ExcelServices.ChartSeriesCollection Load(OfficeExtension.LoadOption option) 
		{
