...
namespace Microsoft.ExcelServices
{
	...
	public class NamedItemCollection: OfficeExtension.ClientObject
	{
		private Microsoft.ExcelServices.NamedItem[] m__items;

		/* Begin_PlaceHolder_NamedItemCollection_Custom_Members */
		/* End_PlaceHolder_NamedItemCollection_Custom_Members */
		public NamedItemCollection(OfficeExtension.ClientRequestContext context, OfficeExtension.ObjectPath objectPath)
		...
		public Microsoft.ExcelServices.NamedItem[] Items
		{
			get
			{
		...
		public Microsoft.ExcelServices.NamedItem GetItem(string name)
		{
			/* Begin_PlaceHolder_NamedItemCollection_GetItem */
			/* End_PlaceHolder_NamedItemCollection_GetItem */
			return new Microsoft.ExcelServices.NamedItem(this.Context, OfficeExtension.ObjectPathFactory._CreateIndexerObjectPath(this.Context, this, new object[] {name}));
		}
		...
		public override void _HandleResult(Newtonsoft.Json.Linq.JToken value)
		{
			...
			if (itemsData != null)
			{
				...
				{
					var _item = new Microsoft.ExcelServices.NamedItem(this.Context, OfficeExtension.ObjectPathFactory._CreateChildItemObjectPathUsingIndexerOrGetItemAt(true, this.Context, this, itemsData[i], i));
		 ...
		 */
		public Microsoft.ExcelServices.NamedItemCollection Load(OfficeExtension.LoadOption option) 
		{
